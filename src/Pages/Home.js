...
function Home() {
  return (
    <div className="vh-100 p-5 justify-content-center bg-dark text-white">
      <Container fluid>
        <Container>
                ...
                params={{
                  particles: {
                    ...
                    shape: {
                      ...
                      stroke: {
                        width: 0,
                        color: "#ffffff", // Set particle stroke color to white
                      },
                      polygon: {
                        nb_sides: 5,
                      },
                    ...
                    line_linked: {
                      enable: true,
                      distance: 150,
                      color: "#ffffff", // Set particle line color to white
                      opacity: 0.4,
                      width: 1,
                    },
                    move: {
          ...
          <Col sm={8} className="mr-3">
            <div className="mt-4 d-flex flex-column justify-content-between">
              ...
              <p>
                ...
                produce my desired output, the rest has been an absolute love of
                code. I still remember sitting in front of a computer and making
                it print "hello world" for the first time on my screen. Guess
                what! It was magic to me, and since then, I have developed a
                strong desire to learn coding. There is certainly yet more to
                learn, yet more to solve, yet more to build, and for this, I am
                very grateful.
              </p>
              <p>
                ...
                yourself. Be passionate. Work hard. It’s never too late. I'm
                just scratching the surface; I still have a long way to go to
                get to where I want to be. Will you help me get there?
              </p>
            </div>
          </Col>
          <Col sm={4}>
